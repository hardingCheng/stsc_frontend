  ...
  <div class="message-notification">
    <div class="message-notification-tab">
      <ul class="message-notification-tab-ul">
        <li @click="liswitch(1)" :class="[isTabActive === 1 ? 'active' :'']">买家({{this.messageObj.notice }})</li>
        <li @click="liswitch(2)" :class="[isTabActive === 2 ? 'active' :'']">卖家({{ this.messageObj.handle }})</li>
